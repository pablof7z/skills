#!/usr/bin/env python3
"""End-to-end contract tests for durable TTS brief attachments."""
            ...
            try:
                ...
                result = subprocess.run(
                    [
                        ...
                        "--summary",
                        "The spoken update includes four durable supporting artifacts.",
                        "--attach",
                        "Why this matters",
                        str(markdown),
                        "--attach",
            ...
            try:
                ...
                subprocess.run(
                    [
                        ...
                        "--summary",
                        "Code remains visual while its description is spoken.",
                        "--message",
                        message,
                    ],
                    env=environment,
