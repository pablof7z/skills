...
mkdir -p "${LOCAL_HOME}/.agents/skills/alpha/meta-feedback" \
  ...
  "${LOCAL_HOME}/.agents/skills/tts/meta-feedback" \
  ...
  "${REMOTE_HOME}/.agents/skills/tts/sessions" \
  "${REMOTE_HOME}/.agents/skills/tts/scripts" "${FAKE_BIN}"
...
printf 'feedback\n' \
  >"${LOCAL_HOME}/.agents/skills/tts/meta-feedback/report.md"
printf 'retired skill\n' >"${LOCAL_HOME}/.agents/skills/tts/SKILL.md"
...
printf 'remote session\n' \
  >"${REMOTE_HOME}/.agents/skills/tts/sessions/item"
printf 'remote retired skill\n' \
  >"${REMOTE_HOME}/.agents/skills/tts/SKILL.md"
printf 'remote retired command\n' \
  >"${REMOTE_HOME}/.agents/skills/tts/scripts/tts"
...
assert_file "${LOCAL_HOME}/.agents/skills/tts/sessions/item" \
  'session' 'retired skill sessions preserved'
assert_file "${LOCAL_HOME}/.agents/skills/tts/meta-feedback/report.md" \
  'feedback' 'retired skill feedback preserved'
[[ ! -e "${LOCAL_HOME}/.agents/skills/tts/SKILL.md" ]] \
  || fail 'retired skill entrypoint survived'
...
assert_file "${REMOTE_HOME}/.agents/skills/tts/sessions/item" \
  'remote session' 'remote retired skill sessions preserved'
[[ ! -e "${REMOTE_HOME}/.agents/skills/tts/SKILL.md" ]] \
  || fail 'remote retired skill entrypoint survived'
[[ ! -e "${REMOTE_HOME}/.agents/skills/tts/scripts" ]] \
  || fail 'remote retired skill scripts survived'
echo 'ok: retired skill payload removed'
