...
`hash-out` gives that path a durable shape while the thinking is still alive.
...
```text
$hash-out help me work through whether query ownership belongs in the engine or the app shell.
```
